...
def banner():
  ...
  ##    ## ####    ##    ##     ## #### 
\033[0;37m╔═══════════════════════════════════════╗ \033[0;37m
║[•] Author   : BROTHER X NITAI         ║
║[•] Facebook : Nitai Chandra Sutradhar ║
║[•] Github   : github.com/N1T41        ║
║[•] Status   : Premium                 ║
║[•] Network  : 3G,4G/5G ON             ║
║[•] Version  : 1.0.7                   ║                     
║[•] Tools    : PUBLIC CLONING          ║
\033[0;37m╚═══════════════════════════════════════╝ \033[0;37m
''')
# LOGIN
def login():
...
def setting():
	...
	print('______________________________________________________\n')
	print('[✔][1] MOBILE FACEBOOK [recommend]')
	print('[✔][2] MBASIC FACEBOOK [Test]')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{b}[NITAI]{P}[{k}{loop}{P}/{h}{len(id)}{P}]-{P}[{H}OK - {ok}{P}]-{P}[{k}CP - {cp}{x}]-[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
	sys.stdout.flush()
