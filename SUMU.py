...
def menu(my_name,my_id):
	...
	print('\033[1;32m└────────────────────────────────────────────┘')
	print('\033[1;32m┌────────────────────────────────────────────┐') 
	print(f"{P}\033[1;92m│[{H}•{P}\033[1;92m]\033[1;92m YOUR IP   : {ip}\033[1;92m              │")
	print(f"{P}\033[1;92m│[{H}•{P}\033[1;92m]\033[1;92m NAME      : {my_name}\033[1;92m             │")
	print(f"{P}\033[1;92m│[{H}•{P}\033[1;92m]\033[1;92m YOUR ID   : {my_id}\033[1;92m             │")
	print('\033[1;32m└────────────────────────────────────────────┘')
	print("%s══════════════════════════════════════════"%(N))
