...
def banner():
	clear()
	masud(f'''\t
            		   \n         [\033[1;97m\033[1;41m  WELLCOME TO MY TOOL   \033[0m\033[1;93m]\n
...
\n\033[0;95m   [•]════════════════════════════════[•]\033[0;95m
   \033[92;1m[✔] TOOL CREATE : BROTHER X NITAI
   [✔] FACEBOOK    : NITAI CHANDRA SUTRADHAR
   [✔] GITHUB      : N1T41\033[92;1m
   [✔] STATUS      : FREE
   [✔] NETWORK     : 3G-4G-5G ON
   [✔] VERSION     : 1.0.7
   [✔] WHATSAPP    : 01933994710
   \033[0;95m[•]════════════════════════════════[•]\033[0;95m
''')
# LOGIN
def login():
...
def login_c():
	try:
		...
		cookie=input(f'   %s[%s✔%s]%s Enter fresh Cookie %s: '%(H,N,H,N,H))
